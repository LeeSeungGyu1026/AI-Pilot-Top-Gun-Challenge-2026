...
RUN_TAG = "codex_ic_s4_mixed_anchor_guard_validation_v1"
BUNDLE = "artifacts/models/team01/codex_ic_s4_mixed_anchor_guard_v1"
EXPERIMENT_YAML = "experiments/codex_ic_s4_mixed_anchor_guard_v1.yaml"
OUT_DIR = ROOT / "artifacts" / "eval" / RUN_TAG


CASES = [
    {
        "name": "codex_ic_s4_mixed_anchor_guard_bt_eval_v1",
        "episodes": 30,
        "target": "bt",
        "purpose": "Check whether BT performance survived the mixed-anchor fine-tune.",
    },
    {
        "name": "codex_ic_s4_mixed_anchor_guard_autopilot_eval_v1",
        "episodes": 20,
        "target": "autopilot",
        "purpose": "Check whether autopilot ownship-altitude losses improved.",
    },
    {
        "name": "codex_ic_s4_mixed_anchor_guard_loiter_eval_v1",
        "episodes": 30,
        "target": "loiter",
        "purpose": "Quantify whether loiter draw/loss collapse improved.",
    },
]
...
def write_summary(results: list[dict]) -> None:
    ...
    lines += [
        ...
        "- Loiter win rate >= 0.50, draw rate <= 0.40, and loss/crash rate <= 0.05.",
        "- If gates pass, freeze as PPO stabilization candidate.",
        "",
    ]
