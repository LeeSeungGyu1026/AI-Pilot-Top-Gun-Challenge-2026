...
def main() -> int:
    ...
    # Force UTF-8 stdout/stderr in the training subprocess. On Windows with a
    # non-UTF8 console locale (e.g. Korean cp949), redirected output otherwise
    # uses the locale codec, and the platform's "[Restore] ✓/✗" prints crash
    # the run with UnicodeEncodeError at every curriculum stage boundary.
