...
def describe_reward(reward_config: dict, wez_config: dict) -> dict:
    return {
        ...
        "step_penalty": reward_config.get("step_penalty", -0.002),
        "damage_scale": reward_config.get("damage_scale", 0.0),
        ...
        "low_altitude_penalty": reward_config.get("low_altitude_penalty", 0.0),
        "win_reward": reward_config.get("win_reward", 100.0),
        "loss_reward": reward_config.get("loss_reward", -100.0),
        "draw_reward": reward_config.get("draw_reward", -30.0),
